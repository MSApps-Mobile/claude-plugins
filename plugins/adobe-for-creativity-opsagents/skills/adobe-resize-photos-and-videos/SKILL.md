...
description: >
  Resize photos and videos to exact pixel dimensions or aspect ratios for
  OpsAgents work — Shopify product imagery (2048x2048 / 1500x2000), web
  heroes for opsagents.agency and msapps.mobi (1920x1080), OpsAgents
  Studio model shots (1080x1920 / 1080x1080), blog featured images
  (1600x900), and LinkedIn share cards (1200x627). Use this skill
  whenever Michal says "resize this to 1920x1080", "make a Shopify
  square", "prep for the studio drop", "resize for the blog", "web hero
  size", "make this 4K", "scale to [WxH]", "change resolution", or any
  request specifying target dimensions (W×H, ratio, or named size).
  NOT for social media platform sets (use adobe-create-social-variations
  for that). Uses image_crop_and_resize for photos, video_resize for
  videos.
license: Apache-2.0
metadata:
  version: 1.0.1
...
AskUserQuestion([{
  ...
  type: "multi_select",
  options: [
    "2048 × 2048 — Shopify product square (Mama Sally / clients)",
    "1500 × 2000 — Shopify product portrait",
    "1920 × 1080 — Web hero (opsagents.agency / msapps.mobi)",
    "1080 × 1920 — OpsAgents Studio vertical",
    "1080 × 1080 — OpsAgents Studio square",
    "1600 × 900 — Blog featured image",
...
AskUserQuestion([{
  ...
  type: "multi_select",
  options: [
    "1080 × 1920 — Studio reel / TikTok / IG Reel (default for OpsAgents Studio)",
    "1920 × 1080 — OpsAgents demo / pitch reel / LinkedIn / YouTube horizontal",
    "1080 × 1080 — Square post (LinkedIn / IG)",
    "1280 × 720 — Web embed / 720p",
    "3840 × 2160 — 4K / UHD master",
    "854 × 480 — SD / 480p",
    "Custom — I'll type it"
  ]
}])
