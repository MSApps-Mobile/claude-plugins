...
description: >
  Create a punchy sizzle reel from a video using Adobe Quick Cut — tuned
  for OpsAgents Studio fashion shoots, OpsAgents demo highlight reels,
  MSApps blog/launch videos, and Mama Sally / Shopify client product
  videos. Use this skill whenever Michal says "make a sizzle reel from
  this Studio shoot", "cut a TikTok reel", "highlight reel for the
  demo", "shorten this video", "sizzle for OpsAgents", "make a TikTok
  out of this", or any request to produce a shorter edited version of a
  video. Use this skill for Quick Cut requests before suggesting manual
...
- Default cut for **OpsAgents Studio** clips: **Short Cut** (~15s) with **Cinematic & Dramatic** vibe — output 9:16 vertical so it drops straight into TikTok and Instagram Reels.
- Default cut for **OpsAgents demo / pitch reels** (lead-response demos, partner announcements): **Long Cut** (~90s) with **Key Talking Moments** vibe — output 16:9 horizontal for LinkedIn / YouTube.
- Default cut for **MSApps client launch videos**: **Medium Cut** (~30–60s) with **Action & Energy** vibe — output 16:9 horizontal.
- Default cut for **Mama Sally / Shopify product videos**: **Short Cut** (~15s) with **Action & Energy** vibe — output 9:16 vertical.

If the brand is clear from context, skip the Cut Length and Style questions and confirm the inferred defaults instead. Save outputs under `<workspace>/<brand>/<YYYY-MM-DD>/reels/` per `CONTEXT.md`.
  ...
  questions: [
    {
      ...
      multiSelect: false,
      options: [
        { label: "Short Cut — TikTok / Instagram Reel for OpsAgents Studio (~15s, high energy)" },
        { label: "Medium Cut — Engaging Storytelling (~30–60s, context, flow, balanced)" },
        { label: "Long Cut — Full Sizzle / OpsAgents demo or pitch reel (~90s, showcase)" }
      ]
    },
    {
      header: "Style / Vibe",
...
| 3. Cinematic & Dramatic | `"Documentary, cinematic, immersive. Let moments breathe and unfold naturally. Build a story stricharc with texture and depth. Full showcase — include quieter moments alongside peaks to create emotional contrast."` |
