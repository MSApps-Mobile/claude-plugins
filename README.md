...
| [**claude-in-chrome-fixer**](./plugins/claude-in-chrome-fixer) | Auto-diagnose & repair Chrome MCP connections on a schedule | `claude-in-chrome-fixer@msapps-plugins` |
| [**rtl-chat**](./plugins/rtl-chat) | Right-to-left inline text formatting for Hebrew, Arabic & more | `rtl-chat@msapps-plugins` |
